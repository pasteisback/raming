if identifyexecutor == "Solara" or identifyexecutor == "Solara V3.0.0" or identifyexecutor == "Xeno" or identifyexecutor == "Cloudy" or identifyexecutor == "Forlorn" then 
	warn("your executor is ass, cannot load vape. :skull:")
	return
end
...
local whitelist = loadstring(game:HttpGet("https://raw.githubusercontent.com/pasteisback/mydiscordid/refs/heads/main/whitelist.json"))()
